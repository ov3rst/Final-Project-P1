...
public class frmBillsReport extends JPanel {
	...
	public frmBillsReport() {
		...
		JLabel lblBillsReport = new JLabel("Reporte de Gastos");
		lblBillsReport.setFont(new Font("Times New Roman", Font.PLAIN, 26));
		lblBillsReport.setBounds(10, 8, 216, 31);
		pnl1.add(lblBillsReport);
